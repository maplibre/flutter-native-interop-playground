...
class MapObserver : public mbgl::MapObserver {
  ...
  void onDidFinishLoadingMap() override { std::cout << "onDidFinishLoadingMap" << std::endl; }
  ...
  void onDidFinishRenderingMap(RenderMode) override { std::cout << "onDidFinishRenderingMap" << std::endl; }

  void onDidFinishLoadingStyle() override { std::cout << "onDidFinishLoadingStyle" << std::endl; }

  void onSourceChanged(mbgl::style::Source& source) override {
    std::cout << "onSourceChanged: " << source.getID() << std::endl;
  }

  void onDidBecomeIdle() override { std::cout << "onDidBecomeIdle" << std::endl; }

  void onStyleImageMissing(const std::string&) override { std::cout << "onStyleImageMissing" << std::endl; }
